...
export const MerchantOverview: React.FC = () => {
  ...
  const {
    ...
    queryKey: [
      MerchantQueryKeys.dateRangePolicies,
      activeStartDate,
      activeEndDate,
    ],
  ...
  return (
    <>
      {!isMediaQueryMatched && (
        <div className="px-5 pb-6 max-w-[850px] mx-auto">
          ...
          <div className="my-4 sm:w-auto sm:flex sm:space-x-4">
            <div className="flex">
          ...
          <div className="flex flex-wrap">
            ...
            <div className="mb-8 w-full max-w-[200px]">
              ...
              <em className="not-italic block text-[#333] text-xl font-semibold">
                {formatToNaira(0.1 * totalPolicyValue)}
              </em>
            </div>
          </div>
          <hr />
